...
因该计算机科学建立在一套优雅而强大的基本思想之上，才能使其巨大生产力成为可能。所有计算都始于三点：表示信息、指定处理逻辑、设计抽象去管理该逻辑复杂性，而掌握这些基础需要我们去精确理解计算机程序的构造和解释。
...
为了理解计算过程，我们需要一种被人们广泛使用和各类电脑广泛接受的编程语言。在本课中，我们将主要使用 [Python](http://docs.python.org/py3k/) 语言。
